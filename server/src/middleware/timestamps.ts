...
export const setTimeCreated = (req:Request, res: Response, next: NextFunction) =>{
...
export const setTimeUpdated = (req:Request, res: Response, next: NextFunction) =>{
...
export const setTimeLastLogin = (req:Request, res: Response, next: NextFunction) =>{
