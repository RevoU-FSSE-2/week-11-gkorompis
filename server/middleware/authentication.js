...
export const verifyLoginUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        req.body = Object.assign(Object.assign({}, body), userDb);
        next();
    }
    catch (error) {
...
export const verifyToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!authorizationHeader)
            return res.status(400).json({ message: 'Bad request headers at verifyToken' });
        //expect token is found
        const token = authorizationHeader.split(' ')[1];
        if (!token)
            return res.status(401).json({ message: 'Bad request headers at verifyToken' });
