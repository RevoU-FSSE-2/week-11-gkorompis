...
// upload to S3
export const uploadFromServerToS3 = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const fileData = yield fs.promises.readFile(filePath);
...
//download from s3
export const getSignedS3Url = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { params } = req;
        if (!params) {
        ...
        const s3url = yield getSignedUrl(client, command, { expiresIn: 15 * 60 }); // expires in seconds
